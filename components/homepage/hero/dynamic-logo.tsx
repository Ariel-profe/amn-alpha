...
export const DynamicLogo = () => {	
	...
	const [pathColor, setPathColor] = useState("#1e208a");
	 ...
	 viewBox="0 0 800 317.5" xmlSpace="preserve">
		...
		<g id="Capa_1-2">
			...
			<motion.path 
				...
				transition={{ duration: 6 }} d="M491.6,166c9.5,1.3,18.1,1.5,25.9,0.9c0.2-1,0.5-1.9,1.1-2.7c-11.7-19.6-11.7-40.3-8.4-56.7
			...
			<motion.path 
				...
				initial={{ pathLength: 0 }}
				animate={isInView && { pathLength: 1 }}
				transition={{ duration: 6 }} d="M487.2,103.5c7.7-2.6,15-4.1,21.8-4.7c0.9-1.7,2.4-3.1,4.4-3.7c3-9.2,6.4-15.9,7.8-18.5
			...
			<motion.path 
				...
				initial={{ pathLength: 0 }}
				animate={isInView && { pathLength: 1 }}
				transition={{ duration: 6 }} d="M577,126.5c1.5-0.4,3-0.3,4.4,0.2c4.3-8,6.3-15,7.2-18.4c-10.3-23.5-35.5-37.5-61.2-33.2c-3.8,7-6.8,13.7-9,20
			...
			<motion.path 
				...
				initial={{ pathLength: 0 }}
				animate={isInView && { pathLength: 1 }}
				transition={{ duration: 6 }} d="M573.6,138.8c-0.9-0.9-1.5-2-1.9-3.3c-0.4-1.6-0.3-3.1,0.3-4.5c-15.9-18.4-33.7-25.3-49.2-27
			...
			<motion.path 
				...
				initial={{ pathLength: 0 }}
				animate={isInView && { pathLength: 1 }}
				transition={{ duration: 6 }} d="M496.3,171.3c11.4,11.5,27.4,17.9,44.2,16.8c-5.3-4.1-9.8-8.3-13.6-12.6c0,0-0.1,0-0.1,0
			...
			<motion.path 
				...
				initial={{ pathLength: 0 }}
				animate={isInView && { pathLength: 1 }}
				transition={{ duration: 6 }} d="M591.2,115.1c-1.7,5.3-3.7,10.2-5.9,14.6c0.4,0.7,0.8,1.4,1,2.2c0.7,2.7-0.2,5.4-2.1,7.2
			...
			<motion.path 
				...
				initial={{ pathLength: 0 }}
				animate={isInView && { pathLength: 1 }}
				transition={{ duration: 6 }} d="M579.7,142.5c-14,16.1-31.8,22.7-47.8,25.1c-0.3,1.2-0.9,2.3-1.7,3.2c5.8,7.9,11.8,13.2,14.9,15.6
		...
		<g fill="#862848">
			<path d="M30.4,310.9c-5,0-8.8-1.3-11.4-4c-2.6-2.7-4-6.3-4-11c0-4.9,1.3-8.7,3.8-11.5c2.6-2.7,6.4-4.1,11.5-4.1
				...
				L30.4,310.9z"/>
			<path d="M65.3,310.9c-9.6,0-14.4-5.1-14.4-15.2c0-5.4,1.2-9.4,3.6-11.8c2.4-2.4,6-3.6,10.8-3.6s8.4,1.2,10.8,3.6
			...
			<path d="M93.1,310.4v-29.7h5.4l14,19.8v-19.8h6.2v29.7h-5.4l-14-19.8v19.8C99.3,310.4,93.1,310.4,93.1,310.4z"/>
			<path d="M142.3,310.9c-1.9,0-3.7-0.1-5.3-0.4c-1.6-0.3-3.1-0.7-4.3-1.2v-5.5c1.3,0.6,2.8,1,4.4,1.3
			...
			<path d="M180.3,310.9c-4.1,0-7.3-1-9.7-3c-2.4-2-3.6-4.9-3.6-8.6v-18.5h6.2v18c0,2.3,0.6,4,1.8,5.1
			...
			<path d="M207.8,310.4v-29.7h6.2v24.9h14.6v4.8L207.8,310.4L207.8,310.4z"/>
			<path d="M244.4,310.4v-24.9h-9.1v-4.8h24.4v4.8h-9.1v24.9H244.4L244.4,310.4z"/>
			<path d="M285,310.9c-9.6,0-14.4-5.1-14.4-15.2c0-5.4,1.2-9.4,3.6-11.8c2.4-2.4,6-3.6,10.8-3.6s8.3,1.2,10.8,3.6
			...
			<path d="M312.8,310.4v-29.7H327c3.4,0,5.9,0.9,7.5,2.7c1.6,1.8,2.4,4.2,2.4,7.3c0,2-0.5,3.7-1.5,5.2
			...
			<path d="M349.1,310.4l11.3-29.7h6.8l11.3,29.7h-6.4l-2.8-7.1h-10.9l-2.8,7.1H349.1L349.1,310.4z M359.3,298.5h9.1
				l-4.6-11.9L359.3,298.5z"/>
			<path d="M411.4,310.4v-29.7h6.2v29.7H411.4z"/>
			<path d="M432.1,310.4v-29.7h5.4l14,19.8v-19.8h6.2v29.7h-5.4l-14-19.8v19.8H432.1z"/>
			<path d="M472.2,310.4v-29.7H493v4.8h-14.6v7.6h12.9v4.8h-12.9v12.4H472.2z"/>
			<path d="M518.4,310.9c-9.6,0-14.4-5.1-14.4-15.2c0-5.4,1.2-9.4,3.6-11.8c2.4-2.4,6-3.6,10.8-3.6
			...
			<path d="M546.2,310.4v-29.7h14.2c3.4,0,5.9,0.9,7.5,2.7s2.4,4.2,2.4,7.3c0,2-0.5,3.7-1.5,5.2c-1,1.4-2.5,2.5-4.4,3.1
			...
			<path d="M583.6,310.4v-29.7h6.3l8.7,17.8l8.7-17.8h6.2v29.7h-6.2v-19.3l-6.9,14.2h-3.6l-7-14.2v19.3H583.6L583.6,310.4
				z"/>
			<path d="M626.2,310.4l11.3-29.7h6.8l11.3,29.7h-6.4l-2.8-7.1h-10.9l-2.8,7.1H626.2L626.2,310.4z M636.4,298.5h9.1
				l-4.6-11.9L636.4,298.5z M638.2,278.7l3.7-8.6h5.4l-4.1,8.6H638.2L638.2,278.7z"/>
			<path d="M671.9,310.4v-24.9h-9.1v-4.8h24.4v4.8h-9.1v24.9H671.9z"/>
			<path d="M699.5,310.4v-29.7h6.2v29.7H699.5z"/>
			<path d="M734.4,310.9c-5,0-8.8-1.3-11.4-4c-2.6-2.7-4-6.3-4-11c0-4.9,1.3-8.7,3.8-11.5c2.6-2.7,6.4-4.1,11.5-4.1
				c1.8,0,3.4,0.1,4.8,0.4s2.8,0.6,4,1.1v5.4c-2.6-1.1-5.4-1.6-8.4-1.6c-3.4,0-5.8,0.8-7.3,2.5c-1.5,1.7-2.2,4.3-2.2,7.7
			...
			<path d="M755.6,310.4l11.3-29.7h6.8l11.3,29.7h-6.4l-2.8-7.1h-10.9l-2.8,7.1H755.6L755.6,310.4z M765.8,298.5h9.1
