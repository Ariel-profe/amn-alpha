...
export function ContactForm() {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center w-full h-full">
        <div id="formulario" className="lg:w-2/3 my-20 w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black ">
        ...
        <form className="my-8" onSubmit={handleSubmit}>
            ...
            <button
            className="bg-gradient-to-br relative group/btn from-slate-800 dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800 w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
            type="submit"
            >
            Enviar &rarr;
            <BottomGradient />
        ...
        <div className="w-full lg:w-1/3 flex items-center justify-center">
            <img src="/images/banner.png" alt="banner-amn" className="rounded-2xl max-h-[640px]" />
        </div>
    </div>
  );
}
