...
const GraphicDesign = () => {
    return ( 
    <div className="lg:mt-32 flex items-center mx-auto relative w-full " id="diseno_grafico">
      ...
      <div className="items-center md:flex justify-center lg:w-2/3 md:space-x-4">
        <motion.div
