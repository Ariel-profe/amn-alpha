  ...
  export const GoogleGeminiEffect = ({
    ...
    return (
      <div className={cn("sticky top-20 px-3 mb-10 flex flex-col items-center justify-center", className)}>
        ...
        <p className="text-lg md:text-xl font-normal text-center text-neutral-600 dark:text-neutral-400 my-4 max-w-lg mx-auto">
          {description ||
...
export function Conectivity() {
  ...
  return (
    <div
      className="h-[200vh] w-full dark:border dark:border-white/[0.1] rounded-3xl relative pt-20 overflow-clip"
      ref={ref}
    >
      <GoogleGeminiEffect
        pathLengths={[
