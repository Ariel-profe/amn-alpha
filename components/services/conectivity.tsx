    ...
    return (
      <div className={cn("sticky top-80", className)}>
        <p className="text-lg md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300">
          {title || `Conectate a cualquier dispositivo`}
        </p>
...
export function Conectivity() {
  ...
  return (
    <div
      className="h-[400vh] bg-slate-800 w-full dark:border dark:border-white/[0.1] rounded-3xl relative pt-40 overflow-clip"
      ref={ref}
    >
      <GoogleGeminiEffect
        pathLengths={[
